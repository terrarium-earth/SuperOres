...
public record OreConfig(String name, String prefix, boolean hasDeepslate, OreProperties oreProperties, OreDrop oreDrop, SpawnRate spawnRate, Optional<OreTextureData> textureData) {
    ...
    public static final Codec<OreConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.STRING.fieldOf("prefix").orElse("super").forGetter(OreConfig::prefix),
